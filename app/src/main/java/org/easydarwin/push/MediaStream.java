...
import static svs.meeting.app.MyApplication.BUS;
...
//                        cameraRotationOffset += 180;
    ...
    public void startStream(String url, InitCallback callback) {
        if (PreferenceManager.getDefaultSharedPreferences(MyApplication.getInstance()).getBoolean(MyApplication.KEY_ENABLE_VIDEO, true))
