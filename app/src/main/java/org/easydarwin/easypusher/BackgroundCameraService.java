...
public class BackgroundCameraService extends Service implements TextureView.SurfaceTextureListener {
    ...
    public void onSurfaceTextureAvailable(SurfaceTexture surface, int width, int height) {
        mTexture = surface;
        Log.e("onSurfaceTexture","onSurfaceTextureAvailable");
    ...
    private void backGroundNotificate() {
        ...
        Notification notification =
                new NotificationCompat.Builder(this, MyApplication.CHANNEL_CAMERA)
    ...
    public void onCreate() {
        super.onCreate();
        Log.e("onCreate","onSurfaceTextureAvailable");
